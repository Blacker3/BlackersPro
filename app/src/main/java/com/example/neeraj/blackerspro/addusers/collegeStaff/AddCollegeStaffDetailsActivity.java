...
public class AddCollegeStaffDetailsActivity extends AppCompatActivity {
    ...
    private CircleImageView staff_profile_image_IV;
    ...
    private String staffAR[] = {"select college staff type ", "Information Technolgy Faculty", "Computer Science and Engnering Faculty", "Electronics Faculty", "Mechanical Automobiles Faculty", "Civil Faculty", "Mechanical Production Faculty", "College Staff"};
    ...
    private StorageReference storageReference = FirebaseStorage.getInstance().getReference("profileImages/CollegeStaffProfileImage");


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.add_colleges_teacher_staff);
        findInit();
       userSelection(AddCollegeStaffDetailsActivity.this);
        dateofbirth(AddCollegeStaffDetailsActivity.this, dateET);
        genderSelection();
//profile is image uloading button  click work
        uploadBT.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (spinnerCount == 0) {
                    Toast.makeText(AddCollegeStaffDetailsActivity.this, "Select a College Staff Type !", Toast.LENGTH_LONG).show();

                    return;
                }
                if (uploadTask != null && uploadTask.isInProgress()) {
                    staff_profile_image_IV.setClickable(false);
                    Toast.makeText(AddCollegeStaffDetailsActivity.this, "Profile image is uploading......", Toast.LENGTH_SHORT).show();
                } else {
                    uploadFile();
        ...
        addhodBT.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (count == 1) {
                    Toast.makeText(AddCollegeStaffDetailsActivity.this, "Upload a image!", Toast.LENGTH_SHORT).show();
        ...
        staff_profile_image_IV.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                openFileChooser();
            }
    ...
    private void userSelection(Context mcontext) {
        ...
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<>(context, android.R.layout.simple_spinner_dropdown_item, staffAR);
    ...
    protected void dateofbirth(Context mcontext, EditText meditText) {
    ...
    private void findInit() {
        ...
        facultySP = findViewById(R.id.teacher_staffSP);
        uploadBT = findViewById(R.id.uploadBT);
        addhodBT = findViewById(R.id.addhodBT);
        progressBar = findViewById(R.id.progressbar);
        staff_profile_image_IV = findViewById(R.id.staff_profile_image_IV);
    ...
    private void validateFields() {
        ...
        staff_profile_image_IV.setClickable(false);
        staff_of_college_ref.document(branch ).set(new GetCollegeStaffInfo(name, email, date, mobile, branch, proifle_url, gender))
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        OnvisiblityBtn();
                        Toast.makeText(AddCollegeStaffDetailsActivity.this, "Saved details", Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(@NonNull Exception e) {
                OnvisiblityBtn();
                Toast.makeText(AddCollegeStaffDetailsActivity.this, "Some error occured while adding user details!", Toast.LENGTH_SHORT).show();
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == PICK_IMAGE_REQUEST && resultCode == RESULT_OK && data != null && data.getData() != null) {
            ...
            Picasso.get().load(uriHodProfileImage).into(staff_profile_image_IV);
        }
    }
    ...
    private void uploadFile() {
        if (uriHodProfileImage != null) {
            ...
            final StorageReference fileReference = storageReference.child(branch + "_profile_image." + getFileExtension(uriHodProfileImage));
            ...
            uploadTask = fileReference.putFile(uriHodProfileImage).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    fileReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            staff_profile_image_IV.setClickable(true);

                        }
                    });
                    ++count;
                    Toast.makeText(AddCollegeStaffDetailsActivity.this, "Profile Image uploaded", Toast.LENGTH_SHORT).show();
                ...
                public void onFailure(@NonNull Exception e) {
                    ...
                    Toast.makeText(AddCollegeStaffDetailsActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
