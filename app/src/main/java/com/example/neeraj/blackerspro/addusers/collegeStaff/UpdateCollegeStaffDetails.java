...
import com.example.neeraj.blackerspro.addusers.AddHodDetailsActivity;
...
public class UpdateCollegeStaffDetails extends AppCompatActivity {
    ...
    private String staffAR[] = {"select your branch ", "Information Technolgy Faculty", "Computer Science and Engnering Faculty", "Electronics Faculty", "Mechanical Automobiles Faculty", "Civil Faculty", "Mechanical Production Faculty", "College Staff"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (collectionRef != null && collectionRef != " ") {
            addHodDetailsActivity.dateofbirth(UpdateCollegeStaffDetails.this, dateET);
            ...
            head_of_departments_document_ref.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                ...
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(UpdateCollegeStaffDetails.this, "There is some error occure while getting data ! ", Toast.LENGTH_SHORT).show();
                }
            });
        }
        ...
        uploadBT.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (spinnerCount == 0) {
                    Toast.makeText(UpdateCollegeStaffDetails.this, "Select a branch !", Toast.LENGTH_LONG).show();

                    return;
                }
                if (uploadTask != null && uploadTask.isInProgress()) {
                    staff_profile_image_IV.setClickable(false);
                    Toast.makeText(UpdateCollegeStaffDetails.this, "Profile image is uploading......", Toast.LENGTH_SHORT).show();
                } else {
                    uploadFile();
    ...
    private void findInit() {
        ...
        staff_profile_image_IV = findViewById(R.id.hod_profile_image_IV);
...
// seting the data in the layout fields
    ...
    private void setTheText() {
        Picasso.get().load(proifle_url).into( staff_profile_image_IV);
        fnameET.setText(name, TextView.BufferType.EDITABLE);
        for (int i = 0; i < staffAR.length; i++) {
            if (staffAR[i].equalsIgnoreCase(branch)) {
                spinnerCount = i;
                break;
            }
        }
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<>(this, android.R.layout.simple_spinner_dropdown_item, staffAR);
        ...
        if (uriHodProfileImage != null) {
            ...
            uploadTask = fileReference.putFile(uriHodProfileImage).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    ++count;
                    Toast.makeText(UpdateCollegeStaffDetails.this, "Profile Image uploaded", Toast.LENGTH_SHORT).show();
                ...
                public void onFailure(@NonNull Exception e) {
                    ...
                    Toast.makeText(UpdateCollegeStaffDetails.this, e.getMessage(), Toast.LENGTH_SHORT).show();
        ...
        head_of_departments_document_ref.set(new GetHodInfo(name, email, date, mobile, branch, proifle_url, gender))
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        OnvisiblityBtn();
                        Toast.makeText(UpdateCollegeStaffDetails.this, "Saved details", Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(@NonNull Exception e) {
                OnvisiblityBtn();
                Toast.makeText(UpdateCollegeStaffDetails.this, "Some error occured while adding user details!", Toast.LENGTH_SHORT).show();
